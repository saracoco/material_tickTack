...
# - starting: starting karyotype (generally 1:1)
# - CCF_1: ccf of clone 1
# - karyotype_1: final karyotype of clone 1 
# - karyotype_2: final karyotype of clone 2
# - purity
# It outputs a dataframe where rows corresponds to all expected peaks in VAF for different evolutionary models:
# - karyotype_1, karyotype_2 : karyotyopes of the two subclones in input
# - genotype_1, genotype_2 : rappresentation of the allelic composition of each subclone (ending states)
# - n.clone_1 n.clone_2 : multiplicity of the referred group of mutations in the corresponding clone 
# - peak : VAF 
# - genotype_initial : starting genotype, generally 1:1 = A1B1
# - model : branching or linear
# - model_id : the actual steps the clones took to reach the final configuration
# - role : whether the peak is provate or shared between the subclones
# - karyotype_1 genotype_1 karyotype_2 genotype_2 n.clone_1 n.clone_2  peak genotype_initial model     model_id        role
expectations_subclonal = function(starting='1:1', CCF_1=.7, karyotype_1='2:1', karyotype_2='1:0', purity=.8)
{
