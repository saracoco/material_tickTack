...
for (( i = 1 ; i <= 20 ; i += 1 )) ; do
  echo "i ha valore $i"
  seed=$i
  mkdir -p MutTime_sim_${purity}_${coverage}_${n_clocks}_${n_events}/${seed}
  mkdir -p MutTime_sim_${purity}_${coverage}_${n_clocks}_${n_events}/${seed}/results
  mkdir -p MutTime_sim_${purity}_${coverage}_${n_clocks}_${n_events}/${seed}/plots

  awk -F',' "NR==${SLURM_ARRAY_TASK_ID} { print ; exit }" params_config.txt >> MutTime_sim_${purity}_${coverage}_${n_clocks}_${n_events}/config
