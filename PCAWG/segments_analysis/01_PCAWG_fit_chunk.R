...
process_file <- function(s) {
  tryCatch({
    ...
    saveRDS(x, paste0(new_dir,"/results_extended/",s,".rds"))
    ...
    saveRDS(summarized_results,paste0(new_dir,"/results_summary/",s,".rds"))
    ...
    ggsave(paste0(new_dir,"/plots/plot_timing_h",s,".png"),plot = p, width = 25, height = 5)
    ...
    ggsave(paste0(new_dir,"/plots/plot_timing_all_K_h",s,".png"),plot = plot_model_selection_inference, width = 25, height = 30)
    ...
    saveRDS(results_single, paste0(new_dir, "/results_extended/",s,"_results_single.rds"))
    
    result_tibble_single <- results_single$summarized_results 
    saveRDS(result_tibble_single, paste0(new_dir, "/results_summary/",s,"_result_tibble_single.rds"))
    
    
    p <- tickTack::plot_timing(results_single, segments, colour_by = "karyotype")
    ggsave(paste0(new_dir,"/plots/",s,"plot_timing_s.png"),plot = p, width = 25, height = 5)
